...
$sku=$_POST['sku'];
 ...
 $dat=new product();
  $data1=$dat->productdescription( $productcategory,$productname, $pageurl, $monthlyprice, $annualprice, $sku,$des);
 echo ($data1);
 if($data1!=false){
     echo "<script>alert('data inserted successfully');</script>";
 }
else{
    echo "<script>alert('data does not inserted successfully');</script>";
}
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
              <form  method="post" action="" onsubmit="return(validateAddProduct());" >
              <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
